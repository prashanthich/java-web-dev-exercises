...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Peanut Butter", 1.05, new ArrayList<>(Arrays.asList("Peanut","Butter")));
        Topping topping2 = new Topping("Chocolate Syrup", 1.25, new ArrayList<>(Arrays.asList("Chocolate")));
        Topping topping3 = new Topping("Tooty Fruity", 1.50, new ArrayList<>(Arrays.asList("Fruity")));
        Topping topping4 = new Topping("Sprinkle Mix", 1.75, new ArrayList<>(Arrays.asList("Sprinkles")));
